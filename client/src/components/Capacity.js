...
function CapacityIndicator() {
  ...
  // currentHour = '10';
  // currentMinute = '01';
  // currentDay = 6; // 0 = Sunday, 1 = Monday, 2 = Tuesday, 3 = Wednesday, 4 = Thursday, 5 = Friday, 6 = Saturday
  ...
  const calculateTimeToOpening = () => {
    ...
    // If it's Friday after closing , add 48 hours (2880 minutes) to the difference
    if ((currentTimeInMinutes > timeToMinutes(closingTime)) && currentDay === 5) {
      diff += 48 * 60;
    }
