...
def generate_nutrition_completion(
    title, current_date, safe_title, script_dir, output_dir
):
    print(f"Generating chat completion for item '{title}'")

    # Read the system prompt from file
    nutritionalPromtFilePath = os.path.join(
        script_dir, "nutrition_generator", "nutritionalPrompt.txt"
    )
    ...
    # chat_completion_content = "test chat completion"
